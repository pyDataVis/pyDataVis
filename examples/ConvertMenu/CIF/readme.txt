...
- The simulated XRD pattern is computed from the CIF file and savec in a new file having the same name as the CIF file but with .plt extension ("Si-COD-9008566.plt"). This file is loaded in a new pyDataVis window which shows the simulated pattern.
